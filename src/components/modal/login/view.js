...
export function view(state$) {
    return state$.map(state => {
        ...
        return h(
            'div.content.fade-in',
            { key: 'login', style: { padding: '0 0.4rem' } },
            [
                h(
                    'div.form-group',
                    h(
                ...
                h(
                    'form',
                    { attrs: { name: 'login', method: 'GET', action: '#' } },
                    [
                        h(
                            'div.black.bg-washed-red.pa2.mb2.f7.fade-in',
                            { class: { dn: error === false } },
                            [
                        ...
                        h('div.form-group', [
                            h('label.form-checkbox', [
                                h('input', {
                                    ...
                                    props: { checked: state.rememberMe },
                                }),
                                h('i.form-icon'),
                                ' Recordar mi sesión',
                            ]),
                        ]),
                        h('input.btn.btn-primary.btn-block', {
        ...
        [
            h('div', { class: { dn: sentRecover == false } }, [
                ...
                h('div.toast.toast-success.mb2', [
                    h(
                        'p.lh-copy',
                        'Hemos enviado un correo electrónico con los datos necesarios para restablecer tu contraseña.'
                    ),
                ]),
            ...
            h(
                'form',
                { class: { dn: sentRecover }, attrs: { name: 'forgot' } },
                [
                    h(
                        'div.black.bg-washed-red.pa2.mb2.f7.fade-in',
                        { class: { dn: error === false } },
