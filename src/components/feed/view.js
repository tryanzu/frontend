    ...
    return state$.map(state => {
        ...
        return section('.fade-in.feed.flex.flex-column', [
            section('.tabs', [
                ...
                div('.new-posts.shadow.toast.toast-success', {class: {dn: counters.posts == 0}}, [
                    a('.load-more', `Cargar ${counters.posts} ${counters.posts > 1 ? 'nuevas publicaciones' : 'nueva publicación'}`),
                    span('.icon-cancel.fr')
                ])
            ]),
