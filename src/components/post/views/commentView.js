...
export function commentView(props) {
    ...
    return div({ class: { pb3: noPadding == false }, key: comment.id }, [
        div('.flex', [
            ...
            div([
                a('.v-mid.pointer.reply-to', { class: { dn: isCurrentUsersComment, dib: !isCurrentUsersComment }, dataset: { id: noPadding ? comment.reply_to : comment.id } }, [
        ...
        div('.pt1', virtualize(`<p class="ma0">${markdown.render(comment.content)}</p>`)),
        repliesCount > 0
